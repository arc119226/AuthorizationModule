...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">本服務需要您授權以下權限<br>
    	<c:forEach var="obj" items="${scopeList}">
    		<label>${obj.note }</label><br>
    	</c:forEach>
	...
	<div class="row">
	    <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input id='allow' type="checkbox" checked="checked"> 我同意以上授權
            </label>
          </div>
        </div>
    </div>
    <form action="${pageContext.request.contextPath}/authorize/login"" method="post">
